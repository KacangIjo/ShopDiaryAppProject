...
{
    public class InventoryRecycleAdapter : RecyclerView.Adapter
    {
        ...
        public InventoryRecycleAdapter(List<InventoryViewModel> inventories,List<ProductViewModel> products, Activity activity)
        {
